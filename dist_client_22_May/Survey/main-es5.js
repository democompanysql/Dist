...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_services_api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function HomeComponent_label_79_span_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_label_79_span_9_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
    ...
    function HomeComponent_label_79_span_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
    ...
    function HomeComponent_label_79_span_11_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnamespaceSVG"]();
    ...
    function HomeComponent_label_79_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_label_79_Template_input_ngModelChange_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);

          var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r10.currentQuestion.ansList.answer = $event;
        })("change", function HomeComponent_label_79_Template_input_change_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);
          ...
          return ctx_r12.radioBtnChange(i_r5, answer_r4.ansId);
        });
    ...
    function HomeComponent_div_302_Template(rf, ctx) {
      if (rf & 1) {
        var _r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 128);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_302_Template_div_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r14);

          var ctx_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r13.skipQuestion();
        });
    ...
    function HomeComponent_div_303_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_303_Template_a_click_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16);

          var ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r15.previewQuestion();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_303_Template_a_click_4_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r16);
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(apiService, activatedRoute) {
        var _this = this;
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          // }, 10000);
          this.apiService.post("getSurveyDetails/" + this.id, "").subscribe(function (succ) {
            console.log(succ);
            _this2.originalQuestionSet.question = succ;
            _this2.questionList = succ.ques;

            var sortFn2 = function sortFn2(obj1, obj2) {
              return obj1.quesOrder - obj2.quesOrder;
            };

            _this2.questionList = _this2.questionList.sort(sortFn2);

            var _iterator = _createForOfIteratorHelper(_this2.questionList),
                _step;

            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                var qun = _step.value;
                if (qun.skipLogic != "string") console.log(JSON.parse(qun.skipLogic));
                if (qun.displayLogic != "string") console.log(JSON.parse(qun.displayLogic));
              }
            } catch (err) {
              _iterator.e(err);
            } finally {
            ...
            _this2.activeControl = _this2.questionList[0].quesTypeId;
            _this2.currentQuestionId = 0;
            _this2.currentQuestion = _this2.questionList[0];

            _this2.questionSet.push(_this2.currentQuestion);
          }, function (err) {});
          this.apiService.getIp().subscribe(function (succ) {
            console.log(succ);
            _this2.originalQuestionSet.ipAddress = succ;
          }, function (err) {});
          var OSName = "Unknown";
        ...
        value: function previewQuestion() {
          if (this.currentQuestionId < this.questionList.length - 1) {
            ...
            var prev = this.questionSet[this.questionSet.length - 2];
            this.currentQuestionId = prev.currentQuestionId; // this.currentQuestionId--;
          ...
          } else {// console.log("qustion done")
            // this.activeControl = 0;
          }
        }
      }, {
        key: "nextQuestion",
        value: function nextQuestion(isSkip) {
          var _this3 = this;
          ...
          if (this.currentQuestion.skipped == "true") {//do nothing
          } else {
            this.currentQuestion.skipped = "false";
          }
          ...
          if (this.currentQuestionId < this.questionList.length - 1) {
            ...
            for (var i = 0; i < this.skipLogic.length; i++) {
            ...
            if (skipTo == 0) {
              ...
              for (var _i = 0; _i < this.questionList.length; _i++) {
                ...
                if (this.questionList[_i].quesId == skipTo) {
                  break;
                }
              }
            }
            ...
            var _loop = function _loop() {
              if (currentQuestionId >= _this3.questionList.length) {
                return "break";
              }

              var currentQuestion = _this3.questionList[currentQuestionId];
              var displayLogic = [];
              checkDisplay = 1;
                ...
                if (currentQuestion.displayLogic == "string") {
                  ...
                  if (singleLogic == 1) {
                    for (var _i2 = 0; _i2 < _this3.questionList.length; _i2++) {
                      if (_this3.questionList[_i2].quesId == displayLogic[0].quesId) {
                        if (_this3.questionList[_i2].skipped == "true") {} else {
                          if (_this3.questionList[_i2].answer == displayLogic[0].ansId) {
                            checkDisplay = 0;
                            break;
                          }

                          if (_this3.questionList[_i2].answer == displayLogic[0].data) {
                            checkDisplay = 0;
                            break;
                          }

                          if (_this3.questionList[_i2].answer == displayLogic[0].logics) {
                            checkDisplay = 0;
                            break;
                          }
                        }
                    ...
                    var isValid = function isValid(expr) {
                      try {
                        return eval(expr);
                      } catch (_a) {
                        return false;
                    ...
                    var _loop2 = function _loop2(_i3) {
                      var q = _this3.questionList.filter(function (que) {
                        return que.quesId == displayLogic[_i3].quesId;
                      });

                      if (displayLogic[_i3].ansId) str += q[0].answer + "==" + displayLogic[_i3].ansId;
                      if (displayLogic[_i3].data) str += "'" + q[0].answer + "'=='" + displayLogic[_i3].data + "'";
                      if (displayLogic[_i3].logics) str += "'" + q[0].answer + "'=='" + displayLogic[_i3].logics + "'";
                      if (displayLogic.length - 1 == _i3) return "continue";

                      if (displayLogic[_i3].compartor == "AND") {
                        str += "&&";
                      } else str += "||";
                    };

                    for (var _i3 = 0; _i3 < displayLogic.length; _i3++) {
              ...
              if (checkDisplay) {
                _this3.questionList[currentQuestionId].skipped = "true";
                currentQuestionId++;
              }
            };
            ...
            console.log(this.currentQuestion); // console.log("current question id", this.currentQuestionId)
            ...
            console.log("qustion done");
            this.activeControl = 0;
            this.currentQuestion = this.questionList[this.questionList.length - 1]; // this.questionSet.push(this.currentQuestion);
            ...
            for (var _i4 = 0; _i4 < this.questionSet.length; _i4++) {
              this.questionSet[_i4].ans = this.questionSet[_i4].answer; //this.questionSet[i].skipped="false"

              this.questionSet[_i4].timeTaken = 0; // request.response.push(this.questionSet[i])
            }
            ...
            console.log(request);
            this.complete = true; // show loader

            this.apiService.post("response", request).subscribe(function (succ) {
              console.log(succ); //hide loader
            }, function (err) {
              console.log(err);
            });
        ...
        key: "radioBtnChange",
        value: function radioBtnChange(index, value) {
          this.currentQuestion.answer = value;
        }
      }, {
        key: "getPercentage",
        value: function getPercentage() {
          var per = this.currentQuestionId / (this.questionList.length - 1) * 100; // console.log(per);
        ...
        key: "skipQuestion",
        value: function skipQuestion() {
          this.currentQuestion.skipped = "true";
          this.nextQuestion(true);
        }
      }, {
        key: "asampe",
        value: function asampe() {}
      }]);
    ...
    HomeComponent.ɵfac = function HomeComponent_Factory(t) {
      return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]));
    };
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function HomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_35_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_39_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_55_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_59_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_63_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_67_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_71_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_85_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_90_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_95_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_100_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_105_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_115_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_span_click_122_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_129_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_span_click_136_listener() {
            return ctx.nextQuestion();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_145_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_152_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_164_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_177_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_select_ngModelChange_194_listener($event) {
            return ctx.currentQuestion.countryCode = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_200_listener($event) {
            return ctx.currentQuestion.phoneNo = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_span_click_207_listener() {
            return ctx.nextQuestion();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_214_listener($event) {
            return ctx.currentQuestion.answer = $event;
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_span_click_221_listener() {
            return ctx.nextQuestion();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_span_click_230_listener() {
            return ctx.nextQuestion();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](240, " Statement \xA01");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](248, " Statement\xA0 2");
  ...
  function srcServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        key: "get",
        value: function get(entity, data) {
          return this.http.get(this.baseUrl + entity, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError));
        }
      }, {
        key: "post",
        value: function post(entity, data) {
          console.log("d");
          return this.http.post(this.baseUrl + entity, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError));
        }
      }, {
        key: "getIp",
        value: function getIp() {
          return this.http.get('https://geolocation-db.com/json/').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError));
        }
      }, {
        key: "put",
        value: function put(entity, data) {
          return this.http.post("https://chat.fieldpower.com/" + entity, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError));
        }
      }, {
        key: "delete",
        value: function _delete(entity, data) {
          return this.http["delete"](this.baseUrl + entity, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.handleError));
        }
      }, {
        key: "handleError",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Personal\Umesh\Survey\CodeBase\UI\Guna\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
